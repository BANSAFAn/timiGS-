...
const Footer: React.FC<FooterProps> = ({ t }) => {
  ...
  return (
    <footer className="w-full mt-auto border-t border-white/5 bg-apple-gray-950/30 backdrop-blur-xl z-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-apple-gray-400 text-sm leading-relaxed max-w-sm mb-8 font-medium">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-semibold text-apple-gray-500 uppercase tracking-widest mb-6">Product</h4>
            <ul className="space-y-4">
              {['Download', 'Releases', 'Features'].map((item) => (
                <li key={item}>
                  <a href={`/en/${item.toLowerCase()}`} className="text-apple-gray-400 hover:text-apple-blue text-sm font-medium transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          {/* Resources */}
          <div>
            <h4 className="text-xs font-semibold text-apple-gray-500 uppercase tracking-widest mb-6">Resources</h4>
             <ul className="space-y-4">
              <li>
                <a href="https://github.com/BANSAFAn/timiGS-" className="text-apple-gray-400 hover:text-apple-blue text-sm font-medium transition-colors">
                  GitHub
                </a>
              </li>
              <li>
                <a href="https://github.com/BANSAFAn/timiGS-/issues" className="text-apple-gray-400 hover:text-apple-blue text-sm font-medium transition-colors">
                  Report Issue
                </a>
              </li>
              <li>
                <a href="/en/terms" className="text-apple-gray-400 hover:text-apple-blue text-sm font-medium transition-colors">
                  Terms & Privacy
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-apple-gray-500 text-xs font-medium">
